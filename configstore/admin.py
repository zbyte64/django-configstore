...
class ConfigurationListAdmin(admin.ModelAdmin):
    ...
    def get_form(self, request, obj=None, **kwargs):
        #use the key to get the form
        if obj:
            return LIST_CONFIGS[obj.key].get_form_builder()
        return LIST_CONFIGS[request.GET['key']].get_form_builder()
...
admin.site.register(ConfigurationList, ConfigurationListAdmin)
